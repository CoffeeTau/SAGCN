...
Customized datasets named ``[Model Name]datasets`` can be automatically called.
"""
...
class DIENDataset(SequentialDataset):
    """:class:`DIENDataset` is based on :class:`~recbole.data.datasets.sequential_dataset.SequentialDataset`.
