        ...
        for k in range(self.n_layers):
            ...
            for t in range(0, self.n_iterations):
                ...
                for i in range(0, self.n_factors):
                    ...
                    edge_val2 = edge_val * edge_weight
                    # (num_edge, dim / n_factors)
                    factor_embeddings = matmul(self.edge2head_mat, edge_val2)
                    ...
                    # pre_med_value = torch.tanh(tail_factor_embeddings)
                    # 下面我改了一下
                    # media_value = head_factor_embeddings * tail_factor_embeddings
